...
3. Read `CHATS.MD` — this contains chat-specific rules and context
...
- Do not append to MEMORY.md without pruning something first if it's over 4KB.
...
- The message is clearly directed to me (Luma), and not another bot or person in the group.
